...
//#endregion
//#region ../../node_modules/.pnpm/peek-readable@5.4.2/node_modules/peek-readable/lib/EndOfStreamError.js
...
//#endregion
//#region ../../node_modules/.pnpm/peek-readable@5.4.2/node_modules/peek-readable/lib/AbstractStreamReader.js
var AbstractStreamReader = class {
	...
	async read(buffer, offset, length) {
		...
		if (bytesRead === 0) throw new EndOfStreamError();
		return bytesRead;
	}
	/**
...
//#endregion
//#region ../../node_modules/.pnpm/peek-readable@5.4.2/node_modules/peek-readable/lib/WebStreamReader.js
/**
...
var WebStreamReader = class extends AbstractStreamReader {
	...
	async readFromStream(buffer, offset, length) {
		if (this.endOfStream) throw new EndOfStreamError();
...
//#endregion
//#region ../../node_modules/.pnpm/strtok3@9.1.1/node_modules/strtok3/lib/AbstractTokenizer.js
/**
* Core tokenizer
*/
...
//#endregion
//#region ../../node_modules/.pnpm/strtok3@9.1.1/node_modules/strtok3/lib/ReadStreamTokenizer.js
...
//#endregion
//#region ../../node_modules/.pnpm/strtok3@9.1.1/node_modules/strtok3/lib/BufferTokenizer.js
...
//#endregion
//#region ../../node_modules/.pnpm/strtok3@9.1.1/node_modules/strtok3/lib/core.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/file-type@19.6.0/node_modules/file-type/util.js
...
//#endregion
//#region ../../node_modules/.pnpm/file-type@19.6.0/node_modules/file-type/supported.js
var extensions = [
	"jpg",
	"png",
	"apng",
...
//#endregion
//#region ../../node_modules/.pnpm/file-type@19.6.0/node_modules/file-type/core.js
/**
	...
	async parse(tokenizer) {
		...
		if (this.check([
			...
			try {
				while (tokenizer.position + 30 < tokenizer.fileInfo.size) {
					...
					if (/classes\d*\.dex/.test(zipHeader.filename)) return {
						ext: "apk",
					...
					if (zipHeader.compressedSize === 0) {
						...
						while (nextHeaderIndex < 0 && tokenizer.position < tokenizer.fileInfo.size) {
							...
							nextHeaderIndex = indexOf(this.buffer, new Uint8Array([
								80,
								75,
								3,
								4
		...
		if (this.checkString("%PDF")) {
			try {
				...
				const buffer = new Uint8Array(Math.min(10 * 1024 * 1024, tokenizer.fileInfo.size));
				await tokenizer.readBuffer(buffer, { mayBeLess: true });
				if (includes(buffer, new TextEncoder().encode("AIPrivateData"))) return {
					ext: "ai",
					mime: "application/postscript"
				};
			} catch (error) {
		...
		if (tarHeaderChecksumMatches(this.buffer)) return {
			ext: "tar",
...
//#endregion
export { FileTypeParser, fileTypeFromBlob, fileTypeFromBuffer, fileTypeFromStream, fileTypeFromTokenizer, fileTypeStream, reasonableDetectionSizeInBytes, supportedExtensions, supportedMimeTypes };
