...
import { Xn as shallowRef, _n as watch } from "./runtime-dom.esm-bundler-BEW9uiVc.js";
import "./vue.js";
import { F as isClient, xt as toRef } from "./dist-CVULrtaQ.js";
...
//#endregion
//#region ../../node_modules/.pnpm/@vueuse+integrations@14.3.0_axios@1.16.0_change-case@5.4.4_nprogress@0.2.0_qrcode@1.5.4_66d9ca090da9ce8493f608e0f63ae360/node_modules/@vueuse/integrations/dist/useQRCode.js
...
function useQRCode(text, options) {
	...
	watch(src, async (value) => {
		if (src.value && isClient) result.value = await import_browser.toDataURL(value, options);
	}, { immediate: true });
	return result;
}
//#endregion
