//#region ../../node_modules/.pnpm/watermark-js-plus@1.6.3/node_modules/watermark-js-plus/dist/index.esm.js
/*!
...
var createCustomContentSVG = function(ctx, options) {
	return __awaiter(void 0, void 0, void 0, function() {
		...
		return __generator(this, function(_b) {
			switch (_b.label) {
				case 0:
					svgElement = createSVGElement("svg", { xmlns: "http://www.w3.org/2000/svg" });
					...
					_loop_1 = function(img) {
						...
						return __generator(this, function(_c) {
							switch (_c.label) {
								...
								case 4:
									imgData = _c.sent();
									if (isString(imgData)) img.setAttribute("src", imgData);
									return [3, 6];
								case 5:
									error_1 = _c.sent();
...
var loadImage = function(url, width, height) {
	if (width === void 0) width = void 0;
	if (height === void 0) height = void 0;
	var image = new Image();
...
var generateAnimationStyle = function(movable, backgroundRepeat) {
	if (!movable) return "";
	var horizontalDuration = Math.random() * 6 + 2;
	var verticalDuration = Math.random() * 2 + 2;
	switch (backgroundRepeat) {
		case "repeat": return "animation: 200s linear 0s infinite alternate watermark !important;";
		case "repeat-x": return "animation: ".concat(horizontalDuration, "s linear 0s infinite alternate watermark-vertical !important;'");
		case "repeat-y": return "animation: ".concat(verticalDuration, "s linear 0s infinite alternate watermark-horizontal !important;'");
		case "no-repeat": return "animation: ".concat(horizontalDuration, "s linear 0s infinite alternate watermark-horizontal, ").concat(verticalDuration, "s linear 0s infinite alternate watermark-vertical !important;");
		default: return "";
	}
};
var initialOptions = {
...
var generateRecommendOptions = function(canvas, options, args) {
	...
	if (ctx === null) throw new Error("get context error");
	...
	if (options === null || options === void 0 ? void 0 : options.rotate) options.rotate = (360 - options.rotate % 360) * (Math.PI / 180);
	if (isUndefined(args.textRowMaxWidth)) options.textRowMaxWidth = options.width;
	var result = {
		image: {
			rect: {
	...
	if (["text", "multi-line-text"].includes(options.contentType)) switch (options.textBaseline) {
		case "middle":
...
var protection = (function(need) {
	...
	if (need) Object.defineProperty(window, "MutationObserver", {
		writable: false,
		configurable: false
	});
});
var WatermarkCanvas = function() {
	...
	*/
	WatermarkCanvas.createCanvas = function(width, height) {
		...
		(_a = canvas.getContext("2d")) === null || _a === void 0 || _a.setTransform(ratio, 0, 0, ratio, 0, 0);
		return canvas;
	};
	/**
	* Clean the canvas
	...
	*/
	...
	WatermarkCanvas.prototype.setStyle = function(ctx) {
		...
		if (this.options.textType === "stroke") propName = "strokeStyle";
		var style = this.options.fontColor;
		if ((_a = this.options) === null || _a === void 0 ? void 0 : _a.advancedStyle) switch (this.options.advancedStyle.type) {
			case "linear":
		...
		if (isFunction(this.options.extraDrawFunc)) this.options.extraDrawFunc(ctx);
	};
	WatermarkCanvas.prototype.createLinearGradient = function(ctx) {
		...
		(_q = (_p = (_o = this.options) === null || _o === void 0 ? void 0 : _o.advancedStyle) === null || _p === void 0 ? void 0 : _p.colorStops) === null || _q === void 0 || _q.forEach(function(item) {
	...
	WatermarkCanvas.prototype.createRadialGradient = function(ctx) {
		...
		(_2 = (_1 = (_0 = this.options) === null || _0 === void 0 ? void 0 : _0.advancedStyle) === null || _1 === void 0 ? void 0 : _1.colorStops) === null || _2 === void 0 || _2.forEach(function(item) {
			gradient.addColorStop(item.offset, item.color);
		});
		return gradient;
	};
	...
	WatermarkCanvas.prototype.setText = function(ctx, params) {
		...
		if (this.options.textType === "stroke") methodName = "strokeText";
	...
	WatermarkCanvas.prototype.drawRichText = function(ctx, resolve) {
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0: return [4, createCustomContentSVG(ctx, this.options)];
					case 1:
						obj = _a.sent();
...
var GridLayout = function() {
	...
	GridLayout.prototype.draw = function() {
		...
		if ((_c = this.options.gridLayoutOptions) === null || _c === void 0 ? void 0 : _c.backgroundImage) layoutContext === null || layoutContext === void 0 || layoutContext.drawImage((_d = this.options.gridLayoutOptions) === null || _d === void 0 ? void 0 : _d.backgroundImage, 0, 0, (_e = this.options.gridLayoutOptions) === null || _e === void 0 ? void 0 : _e.width, (_f = this.options.gridLayoutOptions) === null || _f === void 0 ? void 0 : _f.height);
		for (var rowIndex = 0; rowIndex < this.rows; rowIndex++) for (var colIndex = 0; colIndex < this.cols; colIndex++) {
			if (!((_h = (_g = this.matrix) === null || _g === void 0 ? void 0 : _g[rowIndex]) === null || _h === void 0 ? void 0 : _h[colIndex])) continue;
			layoutContext === null || layoutContext === void 0 || layoutContext.drawImage(this.partialCanvas, this.partialWidth * colIndex + this.gap[0] * colIndex, this.partialHeight * rowIndex + this.gap[1] * rowIndex, this.partialWidth, this.partialHeight);
		}
		return layoutCanvas;
	};
	return GridLayout;
...
var renderLayout = function(options, partialCanvas) {
	switch (options.layout) {
		case "grid": return new GridLayout(options, partialCanvas).draw();
		default: return partialCanvas;
	}
};
var generateBackgroundSize = function(options) {
	...
	switch (options.layout) {
		...
		default: return [options.width, options.height];
	}
};
/**
* Watermark class
...
var Watermark = function() {
			...
			return __generator(this, function(_h) {
				switch (_h.label) {
					...
					case 1:
						...
						(_c = this.watermarkCanvas) === null || _c === void 0 || _c.clear();
						...
						if (this.options.mutationObserve) try {
							this.bindMutationObserve();
						} catch (_j) {
							(_e = (_d = this.options).onObserveError) === null || _e === void 0 || _e.call(_d);
						}
						firstDraw && ((_g = (_f = this.options).onSuccess) === null || _g === void 0 || _g.call(_f));
						this.isCreating = false;
						return [2];
				}
			});
	...
	*/
	...
	Watermark.prototype.remove = function() {
		var _a, _b, _c, _d, _e, _f, _g, _h;
		(_b = (_a = this.options).onBeforeDestroy) === null || _b === void 0 || _b.call(_a);
		(_c = this.observer) === null || _c === void 0 || _c.disconnect();
		(_d = this.parentObserve) === null || _d === void 0 || _d.disconnect();
		(_f = (_e = this.watermarkDom) === null || _e === void 0 ? void 0 : _e.parentNode) === null || _f === void 0 || _f.removeChild(this.watermarkDom);
		(_h = (_g = this.options).onDestroyed) === null || _h === void 0 || _h.call(_g);
	};
	Watermark.prototype.initConfigData = function(args, mode) {
		var _this = this;
		if (mode === void 0) mode = "overwrite";
		if (mode === "append") Object.keys(args).forEach(function(key) {
			_this.props && (_this.props[key] = args[key]);
		});
		else this.props = args;
	...
	Watermark.prototype.changeParentElement = function(parent) {
		...
		} else this.parentElement = parent;
		if (!this.parentElement) console.error("[WatermarkJsPlus]: please pass a valid parent element.");
	};
	Watermark.prototype.validateUnique = function() {
		var result = true;
		Array.from(this.parentElement.childNodes).forEach(function(node) {
			if (!result) return;
			if (Object.hasOwnProperty.call(node, "__WATERMARK__")) result = false;
		});
		return result;
	};
	Watermark.prototype.validateContent = function() {
		switch (this.options.contentType) {
			...
			case "multi-line-text":
			case "rich-text":
			case "text": return this.options.content.length > 0;
		}
	};
	Watermark.prototype.checkParentElementType = function() {
		if (["html", "body"].includes(this.parentElement.tagName.toLocaleLowerCase())) return "root";
		return "custom";
	};
	Watermark.prototype.bindMutationObserve = function() {
		var _this = this;
		if (!this.watermarkDom) return;
...
*/
var BlindWatermark = function(_super) {
	...
	*/
	function BlindWatermark(props) {
		...
		return _super.call(this, __assign(__assign({}, props), {
			globalAlpha: .005,
			mode: "blind"
		})) || this;
	}
	...
	BlindWatermark.decode = function(props) {
		...
		if (mode === "canvas") {
			...
			img_1.addEventListener("load", function() {
				...
				for (var i = 0; i < compositeTimes; i++) ctx.fillRect(0, 0, width, height);
				var resultImage = convertImage(canvas);
				if (isFunction(onSuccess)) onSuccess === null || onSuccess === void 0 || onSuccess(resultImage);
			});
		}
	};
...
var ImageWatermark = function() {
	...
	*/
	function ImageWatermark(args) {
		...
		this.props = args;
		this.options = __assign(__assign({}, initialOptions), args);
		if (this.props.crossOrigin) (_a = this.props.dom) === null || _a === void 0 || _a.setAttribute("crossOrigin", "anonymous");
		this.watermarkCanvas = new WatermarkCanvas(this.props, this.options);
			...
			return __generator(this, function(_f) {
				switch (_f.label) {
					...
					case 1:
						...
						(_e = this.watermarkCanvas) === null || _e === void 0 || _e.clear();
						this.drew = true;
						return [2];
				}
			});
