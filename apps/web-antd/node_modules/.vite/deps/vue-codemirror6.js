import { Bt as onUnmounted, It as onMounted, W as computed, Xn as shallowRef, _n as watch, kt as nextTick, mt as h, qn as ref, rt as defineComponent } from "./runtime-dom.esm-bundler-BEW9uiVc.js";
import { $ as ChangeDesc, A as ViewPlugin, B as highlightSpecialChars, D as Direction, E as Decoration, F as getPanel, G as placeholder, H as keymap, J as showDialog, K as rectangularSelection, L as gutter, M as crosshairCursor, N as drawSelection, O as EditorView, P as dropCursor, Q as Annotation, R as highlightActiveLine, S as matchBrackets, T as syntaxTree, Tt as NodeProp, U as lineNumbers, V as hoverTooltip, W as logException, X as showTooltip, Y as showPanel, Z as crelt, _ as getIndentation, _t as combineConfig, a as bracketMatching, at as Facet, b as indentString, bt as fromCodePoint, c as defaultHighlightStyle, ct as RangeSet, dt as StateEffect, et as ChangeSet, f as foldGutter, ft as StateField, g as getIndentUnit, gt as codePointSize, ht as codePointAt, it as EditorState, j as WidgetType, k as GutterMarker, lt as RangeSetBuilder, m as foldKeymap, mt as Transaction, n as IndentContext, nt as Compartment, pt as Text, q as runScopeHandlers, rt as EditorSelection, st as Prec, tt as CharCategory, vt as countColumn, w as syntaxHighlighting, x as indentUnit, y as indentOnInput, yt as findClusterBreak, z as highlightActiveLineGutter } from "./dist-BDSeNiVq.js";
import { a as completionKeymap, n as closeBrackets, r as closeBracketsKeymap, t as autocompletion } from "./dist-DpdFBWud.js";
import "./lib-BthGG4zT.js";
...
//#endregion
//#region ../../node_modules/.pnpm/@codemirror+lint@6.9.5/node_modules/@codemirror/lint/dist/index.js
...
//#endregion
//#region ../../node_modules/.pnpm/@codemirror+search@6.7.0/node_modules/@codemirror/search/dist/index.js
...
//#endregion
//#region ../../node_modules/.pnpm/codemirror@6.0.1/node_modules/codemirror/dist/index.js
/**
...
//#endregion
//#region ../../node_modules/.pnpm/vue-codemirror6@1.3.4_vue@3.5.33_typescript@5.9.3_/node_modules/vue-codemirror6/dist/index.es.js
/**
* vue-codemirror6
*
...
var le = (e) => e ? Object.entries(e).reduce((l, [i, u]) => (i = i.charAt(0).toUpperCase() + i.slice(1), i = `on${i}`, {
	...l,
	[i]: u
}), {}) : {};
function B(e, l = {}, i) {
...
var oe = (e) => typeof e == "function" ? e() : e;
var se = defineComponent({
	...
	*/
	setup(e, l) {
		const i = ref(), u = ref(e.modelValue), t = shallowRef(new EditorView()), d = computed({
		...
		}), S = ref(0), h = ref(0), g = computed(() => {
			const a = new Compartment(), n = new Compartment();
			if (e.basic && e.minimal) throw "[Vue CodeMirror] Both basic and minimal cannot be specified.";
			return [
				e.basic && !e.minimal ? basicSetup : void 0,
				e.minimal && !e.basic ? minimalSetup : void 0,
				EditorView.updateListener.of((o) => {
					l.emit("focus", t.value.hasFocus), S.value = t.value.state.doc?.length, !(o.changes.empty || !o.docChanged) && (e.linter && (e.forceLinting && forceLinting(t.value), h.value = e.linter(t.value).length), l.emit("update", o));
				}),
		...
		watch(g, (a) => {
			t.value?.dispatch({ effects: StateEffect.reconfigure.of(a) });
		}, { immediate: !0 }), watch(() => e.modelValue, async (a) => {
			if (t.value.composing || t.value.state.doc.toJSON().join(e.lineSeparator ?? `
`) === a) return;
			const n = !t.value.state.selection.ranges.every((o) => o.anchor < a.length && o.head < a.length);
			t.value.dispatch({
				changes: {
					from: 0,
				...
				selection: n ? {
					anchor: 0,
					head: 0
				} : t.value.state.selection,
				scrollIntoView: !0
			});
		}, { immediate: !0 }), onMounted(async () => {
			let a = u.value;
			i.value && (i.value.childNodes[0] && (u.value !== "" && console.warn("[CodeMirror.vue] The <code-mirror> tag contains child elements that overwrite the `v-model` values."), a = i.value.childNodes[0].innerText.trim()), t.value = new EditorView({
				parent: i.value,
		...
		const V = () => {
			!e.linter || !t.value || (e.forceLinting && forceLinting(t.value), h.value = diagnosticCount(t.value.state));
		}, j = () => {
			t.value?.dispatch({ effects: StateEffect.reconfigure.of([]) }), t.value?.dispatch({ effects: StateEffect.appendConfig.of(g.value) });
			...
			let a;
			return (a = t.value.state.sliceDoc(t.value.state.selection.main.from, t.value.state.selection.main.to)) !== null && a !== void 0 ? a : "";
		}, R = () => {
			const a = t.value.state;
			return a ? a.selection.ranges.map((n) => a.sliceDoc(n.from, n.to)) : [];
		}, T = () => t.value.state.selection.ranges.some((a) => !a.empty), D = (a, n, o) => t.value.dispatch({ changes: {
			from: n,
			to: o,
			insert: a
		} }), E = (a) => t.value.dispatch(t.value.state.replaceSelection(a)), F = (a) => t.value.dispatch({ selection: { anchor: a } }), J = (a, n) => t.value.dispatch({ selection: {
			anchor: a,
			head: n
		} }), A = (a, n) => t.value.dispatch({ selection: EditorSelection.create(a, n) }), W = (a) => t.value.dispatch({ selection: EditorSelection.create(f.value.ranges.map((n) => n.extend(a(n)))) }), p = {
			editor: i,
			view: t,
			cursor: m,
			selection: f,
	...
	render() {
		return B(this.$props.tag, {
			ref: "editor",
			class: "vue-codemirror"
		}, this.$slots.default ? B("aside", {
			style: "display: none;",
			"aria-hidden": "true"
		}, oe(this.$slots.default)) : void 0);
	}
});
var ge = (e) => e.component("CodeMirror", se);
//#endregion
export { he as Meta, se as default, ge as install };
