import { Bt as onUnmounted, Gn as reactive, Hn as onScopeDispose, It as onMounted, N as Fragment, Pn as getCurrentScope, Qn as toRaw, St as inject, Vt as onUpdated, W as computed, Xn as shallowRef, _n as watch, dt as getCurrentInstance, fn as useSlots, gt as hasInjectionContext, kt as nextTick, mt as h, qn as ref, rr as unref, rt as defineComponent, tr as toValue, vn as watchEffect, zn as isRef } from "./runtime-dom.esm-bundler-BEW9uiVc.js";
import "./vue.js";
import defu from "./defu.js";
import { n as warning, t as invariant } from "./hey-listen.es-BPlDy5Md.js";
...
//#endregion
//#region ../../node_modules/.pnpm/@vueuse+motion@3.0.3_magicast@0.5.2_vue@3.5.33_typescript@5.9.3_/node_modules/@vueuse/motion/dist/index.mjs
var motionState = {};
...
var CUSTOM_PRESETS = Symbol(import.meta.env?.MODE === "development" ? "motionCustomPresets" : "");
...
function setupMotionComponent(props) {
	...
	if (import.meta.env?.MODE === "development") {
		if (props.preset != null && presets?.[props.preset] == null && customPresets?.[props.preset] == null) console.warn(`[@vueuse/motion]: Preset \`${props.preset}\` not found.`);
		...
		onUpdated(() => {
			for (const key in instances) replayAnimation(instances[key]);
		});
	}
...
var MotionPlugin = { install(app, options) {
	...
	if (options && options.directives) for (const key in options.directives) {
		...
		if (!variants.initial && import.meta.env?.MODE === "development") console.warn(`Your directive v-motion-${key} is missing initial variant!`);
