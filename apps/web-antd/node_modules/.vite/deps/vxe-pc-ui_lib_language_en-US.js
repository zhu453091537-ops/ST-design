...
//#region ../../node_modules/.pnpm/vxe-pc-ui@4.14.0_vue@3.5.33_typescript@5.9.3_/node_modules/vxe-pc-ui/lib/language/en-US.js
var require_en_US = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.default = { vxe: {
		...
		datePicker: { yearTitle: "{0} years" },
		dateRangePicker: { pleaseRange: "Please select the date time and the end date" },
		input: { date: {
			m1: "January",
			m2: "February",
			m3: "March",
		...
		contextMenu: { loadingText: "Loading" },
		gantt: {
			tFullFormat: {
				year: "{yyyy}年",
