...
import * as _vueuse_shared2 from "@vueuse/shared";
...
declare function useGraceArea(triggerElement: Ref<HTMLElement | undefined>, containerElement: Ref<HTMLElement | undefined>): {
  isPointerInTransit: _vueuse_shared2.RefAutoResetReturn<boolean>;
  onPointerExit: _vueuse_shared2.EventHookOn<void>;
};
...
declare function useTypeahead(callback?: (search: string) => void): {
  search: _vueuse_shared2.RefAutoResetReturn<string>;
