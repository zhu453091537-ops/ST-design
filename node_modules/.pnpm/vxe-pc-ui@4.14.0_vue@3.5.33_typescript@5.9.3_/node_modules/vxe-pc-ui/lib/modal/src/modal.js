...
var _default = exports.default = (0, _comp.defineVxeComponent)({
  ...
  props: {
    ...
    width: {
      type: [Number, String],
      default: () => (0, _ui.getConfig)().modal.width
    },
    height: {
      type: [Number, String],
      default: () => (0, _ui.getConfig)().modal.height
    },
    minWidth: {
      type: [Number, String],
  ...
  setup(props, context) {
    ...
    const recalculate = () => {
      ...
      if (boxElem) {
        ...
        boxElem.style.minWidth = !isMsg && minWidth ? (0, _dom.toCssUnit)(minWidth) : '';
        boxElem.style.minHeight = !isMsg && minHeight ? (0, _dom.toCssUnit)(minHeight) : '';
      }
