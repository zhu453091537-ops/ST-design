...
export declare const ORDER_ERROR_ID = 'unexpectedNamedExportsOrder'
export declare const GROUP_ORDER_ERROR_ID = 'unexpectedNamedExportsGroupOrder'
export declare const EXTRA_SPACING_ERROR_ID = 'extraSpacingBetweenNamedExports'
