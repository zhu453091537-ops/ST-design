...
import CodepenCircleFilledSvg from "@ant-design/icons-svg/es/asn/CodepenCircleFilled.js";

//#region src/icons/CodepenCircleFilled.tsx
...
const CodepenCircleFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": CodepenCircleFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { CodepenCircleFilled as default };