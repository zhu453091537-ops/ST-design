...
//#region src/icons/ReadFilled.tsx
...
const ReadFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": ReadFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
