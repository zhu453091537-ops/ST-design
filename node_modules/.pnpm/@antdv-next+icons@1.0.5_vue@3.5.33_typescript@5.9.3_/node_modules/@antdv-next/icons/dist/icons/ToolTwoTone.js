...
//#region src/icons/ToolTwoTone.tsx
...
const ToolTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": ToolTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
