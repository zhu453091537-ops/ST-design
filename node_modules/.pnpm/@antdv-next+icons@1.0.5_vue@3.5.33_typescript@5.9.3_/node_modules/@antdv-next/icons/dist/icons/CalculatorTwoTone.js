...
import CalculatorTwoToneSvg from "@ant-design/icons-svg/es/asn/CalculatorTwoTone.js";

//#region src/icons/CalculatorTwoTone.tsx
...
const CalculatorTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": CalculatorTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { CalculatorTwoTone as default };