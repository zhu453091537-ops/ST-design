...
//#region src/icons/AimOutlined.tsx
...
const AimOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": AimOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
