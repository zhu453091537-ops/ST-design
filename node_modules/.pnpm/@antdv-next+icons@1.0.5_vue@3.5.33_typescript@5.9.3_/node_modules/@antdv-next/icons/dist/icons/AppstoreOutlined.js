...
//#region src/icons/AppstoreOutlined.tsx
...
const AppstoreOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": AppstoreOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { AppstoreOutlined as default };