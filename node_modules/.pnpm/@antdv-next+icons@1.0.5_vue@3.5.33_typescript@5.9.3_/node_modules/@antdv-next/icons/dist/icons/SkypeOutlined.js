...
import SkypeOutlinedSvg from "@ant-design/icons-svg/es/asn/SkypeOutlined.js";

//#region src/icons/SkypeOutlined.tsx
...
const SkypeOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": SkypeOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { SkypeOutlined as default };