...
import AmazonCircleFilledSvg from "@ant-design/icons-svg/es/asn/AmazonCircleFilled.js";

//#region src/icons/AmazonCircleFilled.tsx
...
const AmazonCircleFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": AmazonCircleFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { AmazonCircleFilled as default };