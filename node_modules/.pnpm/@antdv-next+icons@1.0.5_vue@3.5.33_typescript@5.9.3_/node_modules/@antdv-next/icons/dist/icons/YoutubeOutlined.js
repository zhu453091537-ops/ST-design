...
//#region src/icons/YoutubeOutlined.tsx
...
const YoutubeOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": YoutubeOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { YoutubeOutlined as default };