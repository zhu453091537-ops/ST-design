...
//#region src/icons/GoldFilled.tsx
...
const GoldFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": GoldFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
