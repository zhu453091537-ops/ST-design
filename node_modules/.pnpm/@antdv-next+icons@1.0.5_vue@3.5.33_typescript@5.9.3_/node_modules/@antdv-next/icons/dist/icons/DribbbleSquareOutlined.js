...
//#region src/icons/DribbbleSquareOutlined.tsx
...
const DribbbleSquareOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": DribbbleSquareOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { DribbbleSquareOutlined as default };