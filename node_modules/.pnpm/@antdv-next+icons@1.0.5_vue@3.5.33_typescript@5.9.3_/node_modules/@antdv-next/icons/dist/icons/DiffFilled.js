...
//#region src/icons/DiffFilled.tsx
...
const DiffFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": DiffFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
