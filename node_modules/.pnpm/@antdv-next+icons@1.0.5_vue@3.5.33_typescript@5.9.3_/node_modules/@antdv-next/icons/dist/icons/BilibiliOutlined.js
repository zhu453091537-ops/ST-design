...
import BilibiliOutlinedSvg from "@ant-design/icons-svg/es/asn/BilibiliOutlined.js";

//#region src/icons/BilibiliOutlined.tsx
...
const BilibiliOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": BilibiliOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { BilibiliOutlined as default };