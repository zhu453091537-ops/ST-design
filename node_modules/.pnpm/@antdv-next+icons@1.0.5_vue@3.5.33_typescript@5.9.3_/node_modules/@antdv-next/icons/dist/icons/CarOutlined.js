...
//#region src/icons/CarOutlined.tsx
...
const CarOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": CarOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
