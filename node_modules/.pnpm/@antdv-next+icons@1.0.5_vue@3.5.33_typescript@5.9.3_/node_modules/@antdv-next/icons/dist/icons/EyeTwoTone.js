...
//#region src/icons/EyeTwoTone.tsx
...
const EyeTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": EyeTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
