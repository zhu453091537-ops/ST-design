...
//#region src/icons/BilibiliFilled.tsx
...
const BilibiliFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": BilibiliFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { BilibiliFilled as default };