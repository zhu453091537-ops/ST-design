...
//#region src/icons/ArrowLeftOutlined.tsx
...
const ArrowLeftOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": ArrowLeftOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
