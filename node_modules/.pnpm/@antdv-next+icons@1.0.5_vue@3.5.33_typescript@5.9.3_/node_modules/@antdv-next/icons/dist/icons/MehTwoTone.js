...
//#region src/icons/MehTwoTone.tsx
...
const MehTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": MehTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
