...
//#region src/icons/CopyrightCircleTwoTone.tsx
...
const CopyrightCircleTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": CopyrightCircleTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { CopyrightCircleTwoTone as default };