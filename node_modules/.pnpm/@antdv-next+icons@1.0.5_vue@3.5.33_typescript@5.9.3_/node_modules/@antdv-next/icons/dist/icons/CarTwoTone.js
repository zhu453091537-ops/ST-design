...
import CarTwoToneSvg from "@ant-design/icons-svg/es/asn/CarTwoTone.js";

//#region src/icons/CarTwoTone.tsx
...
const CarTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": CarTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
