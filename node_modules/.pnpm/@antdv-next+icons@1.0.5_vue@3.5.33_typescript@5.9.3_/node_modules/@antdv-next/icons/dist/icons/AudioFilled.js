...
//#region src/icons/AudioFilled.tsx
...
const AudioFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": AudioFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
