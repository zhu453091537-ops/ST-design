...
import BugTwoToneSvg from "@ant-design/icons-svg/es/asn/BugTwoTone.js";

//#region src/icons/BugTwoTone.tsx
...
const BugTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": BugTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
