...
//#region src/icons/TagsFilled.tsx
...
const TagsFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": TagsFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
