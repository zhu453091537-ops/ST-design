...
import WechatWorkFilledSvg from "@ant-design/icons-svg/es/asn/WechatWorkFilled.js";

//#region src/icons/WechatWorkFilled.tsx
...
const WechatWorkFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": WechatWorkFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { WechatWorkFilled as default };