...
//#region src/icons/PauseCircleTwoTone.tsx
...
const PauseCircleTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": PauseCircleTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { PauseCircleTwoTone as default };