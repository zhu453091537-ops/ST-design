...
import ControlTwoToneSvg from "@ant-design/icons-svg/es/asn/ControlTwoTone.js";

//#region src/icons/ControlTwoTone.tsx
...
const ControlTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": ControlTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { ControlTwoTone as default };