...
import SettingOutlinedSvg from "@ant-design/icons-svg/es/asn/SettingOutlined.js";

//#region src/icons/SettingOutlined.tsx
...
const SettingOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": SettingOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { SettingOutlined as default };