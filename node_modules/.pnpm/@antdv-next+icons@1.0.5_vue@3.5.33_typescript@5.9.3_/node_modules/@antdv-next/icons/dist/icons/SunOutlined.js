...
import SunOutlinedSvg from "@ant-design/icons-svg/es/asn/SunOutlined.js";

//#region src/icons/SunOutlined.tsx
...
const SunOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": SunOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
