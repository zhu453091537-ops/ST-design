...
import FilePdfTwoToneSvg from "@ant-design/icons-svg/es/asn/FilePdfTwoTone.js";

//#region src/icons/FilePdfTwoTone.tsx
...
const FilePdfTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": FilePdfTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { FilePdfTwoTone as default };