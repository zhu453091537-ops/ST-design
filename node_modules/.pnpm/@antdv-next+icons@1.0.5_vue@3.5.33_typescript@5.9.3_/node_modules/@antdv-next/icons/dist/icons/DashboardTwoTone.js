...
import DashboardTwoToneSvg from "@ant-design/icons-svg/es/asn/DashboardTwoTone.js";

//#region src/icons/DashboardTwoTone.tsx
...
const DashboardTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": DashboardTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { DashboardTwoTone as default };