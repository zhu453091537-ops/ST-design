...
//#region src/icons/ZoomInOutlined.tsx
...
const ZoomInOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": ZoomInOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { ZoomInOutlined as default };