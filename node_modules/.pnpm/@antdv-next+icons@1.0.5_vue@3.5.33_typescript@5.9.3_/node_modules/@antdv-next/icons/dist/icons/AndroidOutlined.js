...
import AndroidOutlinedSvg from "@ant-design/icons-svg/es/asn/AndroidOutlined.js";

//#region src/icons/AndroidOutlined.tsx
...
const AndroidOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": AndroidOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { AndroidOutlined as default };