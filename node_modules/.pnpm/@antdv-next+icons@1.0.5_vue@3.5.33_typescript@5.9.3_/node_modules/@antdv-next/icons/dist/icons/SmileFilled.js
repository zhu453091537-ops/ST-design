...
//#region src/icons/SmileFilled.tsx
...
const SmileFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": SmileFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
