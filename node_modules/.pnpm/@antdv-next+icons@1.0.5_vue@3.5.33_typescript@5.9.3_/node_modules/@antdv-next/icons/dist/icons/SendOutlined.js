...
//#region src/icons/SendOutlined.tsx
...
const SendOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": SendOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
