...
import AmazonSquareFilledSvg from "@ant-design/icons-svg/es/asn/AmazonSquareFilled.js";

//#region src/icons/AmazonSquareFilled.tsx
...
const AmazonSquareFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": AmazonSquareFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { AmazonSquareFilled as default };