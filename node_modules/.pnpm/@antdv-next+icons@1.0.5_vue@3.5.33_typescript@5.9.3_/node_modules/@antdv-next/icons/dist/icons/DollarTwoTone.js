...
import DollarTwoToneSvg from "@ant-design/icons-svg/es/asn/DollarTwoTone.js";

//#region src/icons/DollarTwoTone.tsx
...
const DollarTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": DollarTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { DollarTwoTone as default };