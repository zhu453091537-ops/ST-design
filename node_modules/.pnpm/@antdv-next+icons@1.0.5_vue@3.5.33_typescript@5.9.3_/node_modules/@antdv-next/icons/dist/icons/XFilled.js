...
const XFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": XFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
