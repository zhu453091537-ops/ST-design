...
//#region src/icons/FrownFilled.tsx
...
const FrownFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": FrownFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
