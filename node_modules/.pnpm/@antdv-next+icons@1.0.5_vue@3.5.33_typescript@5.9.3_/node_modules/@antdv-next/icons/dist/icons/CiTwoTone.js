...
import CiTwoToneSvg from "@ant-design/icons-svg/es/asn/CiTwoTone.js";

//#region src/icons/CiTwoTone.tsx
...
const CiTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": CiTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
