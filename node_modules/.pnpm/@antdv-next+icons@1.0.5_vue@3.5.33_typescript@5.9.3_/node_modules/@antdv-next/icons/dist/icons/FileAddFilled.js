...
//#region src/icons/FileAddFilled.tsx
...
const FileAddFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": FileAddFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { FileAddFilled as default };