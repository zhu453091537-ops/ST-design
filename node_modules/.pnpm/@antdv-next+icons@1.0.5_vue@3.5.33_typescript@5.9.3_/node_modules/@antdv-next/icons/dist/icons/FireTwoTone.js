...
import FireTwoToneSvg from "@ant-design/icons-svg/es/asn/FireTwoTone.js";

//#region src/icons/FireTwoTone.tsx
...
const FireTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": FireTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
