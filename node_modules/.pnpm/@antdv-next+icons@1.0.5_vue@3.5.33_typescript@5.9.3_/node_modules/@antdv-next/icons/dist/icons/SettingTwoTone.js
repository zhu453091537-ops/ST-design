...
import SettingTwoToneSvg from "@ant-design/icons-svg/es/asn/SettingTwoTone.js";

//#region src/icons/SettingTwoTone.tsx
...
const SettingTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": SettingTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
