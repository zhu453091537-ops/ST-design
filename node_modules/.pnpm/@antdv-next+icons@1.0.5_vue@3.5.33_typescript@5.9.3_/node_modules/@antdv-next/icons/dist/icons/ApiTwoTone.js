...
import ApiTwoToneSvg from "@ant-design/icons-svg/es/asn/ApiTwoTone.js";

//#region src/icons/ApiTwoTone.tsx
...
const ApiTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": ApiTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
