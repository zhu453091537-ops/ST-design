...
//#region src/icons/FileFilled.tsx
...
const FileFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": FileFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
