...
//#region src/icons/HeatMapOutlined.tsx
...
const HeatMapOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": HeatMapOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { HeatMapOutlined as default };