...
//#region src/icons/MehOutlined.tsx
...
const MehOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": MehOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
