...
//#region src/icons/GithubFilled.tsx
...
const GithubFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": GithubFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { GithubFilled as default };