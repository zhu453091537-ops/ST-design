...
import SpotifyFilledSvg from "@ant-design/icons-svg/es/asn/SpotifyFilled.js";

//#region src/icons/SpotifyFilled.tsx
...
const SpotifyFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": SpotifyFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { SpotifyFilled as default };