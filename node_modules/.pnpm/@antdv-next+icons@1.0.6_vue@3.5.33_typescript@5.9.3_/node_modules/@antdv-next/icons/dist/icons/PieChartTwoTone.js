...
import PieChartTwoToneSvg from "@ant-design/icons-svg/es/asn/PieChartTwoTone.js";

//#region src/icons/PieChartTwoTone.tsx
...
const PieChartTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": PieChartTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { PieChartTwoTone as default };