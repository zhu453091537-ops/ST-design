...
//#region src/icons/MergeFilled.tsx
...
const MergeFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": MergeFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
