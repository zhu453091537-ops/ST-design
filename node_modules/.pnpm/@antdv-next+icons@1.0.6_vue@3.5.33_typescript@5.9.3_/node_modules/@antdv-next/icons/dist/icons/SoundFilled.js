...
//#region src/icons/SoundFilled.tsx
...
const SoundFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": SoundFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
