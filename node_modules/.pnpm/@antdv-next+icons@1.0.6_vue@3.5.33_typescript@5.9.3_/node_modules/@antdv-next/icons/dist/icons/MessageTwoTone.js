...
import MessageTwoToneSvg from "@ant-design/icons-svg/es/asn/MessageTwoTone.js";

//#region src/icons/MessageTwoTone.tsx
...
const MessageTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": MessageTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
