...
import GlobalOutlinedSvg from "@ant-design/icons-svg/es/asn/GlobalOutlined.js";

//#region src/icons/GlobalOutlined.tsx
...
const GlobalOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": GlobalOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { GlobalOutlined as default };