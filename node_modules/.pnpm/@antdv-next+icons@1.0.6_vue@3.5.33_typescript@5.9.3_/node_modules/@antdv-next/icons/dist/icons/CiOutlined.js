...
//#region src/icons/CiOutlined.tsx
...
const CiOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": CiOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
