...
//#region src/icons/StarOutlined.tsx
...
const StarOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": StarOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
