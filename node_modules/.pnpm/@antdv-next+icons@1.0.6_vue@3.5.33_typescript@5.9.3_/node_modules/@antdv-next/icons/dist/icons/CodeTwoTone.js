...
//#region src/icons/CodeTwoTone.tsx
...
const CodeTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": CodeTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
