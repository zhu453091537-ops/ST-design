...
//#region src/icons/DashboardFilled.tsx
...
const DashboardFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": DashboardFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { DashboardFilled as default };