...
import FilePdfFilledSvg from "@ant-design/icons-svg/es/asn/FilePdfFilled.js";

//#region src/icons/FilePdfFilled.tsx
...
const FilePdfFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": FilePdfFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { FilePdfFilled as default };