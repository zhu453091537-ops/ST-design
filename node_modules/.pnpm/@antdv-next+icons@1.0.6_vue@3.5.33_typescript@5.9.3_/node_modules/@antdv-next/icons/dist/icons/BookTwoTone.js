...
//#region src/icons/BookTwoTone.tsx
...
const BookTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": BookTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
