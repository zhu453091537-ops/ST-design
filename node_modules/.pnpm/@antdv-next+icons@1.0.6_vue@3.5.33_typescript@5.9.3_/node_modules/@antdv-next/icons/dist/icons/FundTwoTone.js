...
//#region src/icons/FundTwoTone.tsx
...
const FundTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": FundTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
