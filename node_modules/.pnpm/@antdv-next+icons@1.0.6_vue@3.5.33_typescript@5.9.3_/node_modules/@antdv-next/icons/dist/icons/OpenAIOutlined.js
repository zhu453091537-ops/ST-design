...
import OpenAIOutlinedSvg from "@ant-design/icons-svg/es/asn/OpenAIOutlined.js";

//#region src/icons/OpenAIOutlined.tsx
...
const OpenAIOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": OpenAIOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { OpenAIOutlined as default };