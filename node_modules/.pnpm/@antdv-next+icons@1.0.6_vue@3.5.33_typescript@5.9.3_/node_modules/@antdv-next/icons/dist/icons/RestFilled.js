...
//#region src/icons/RestFilled.tsx
...
const RestFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": RestFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
