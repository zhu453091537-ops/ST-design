...
import EuroTwoToneSvg from "@ant-design/icons-svg/es/asn/EuroTwoTone.js";

//#region src/icons/EuroTwoTone.tsx
...
const EuroTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": EuroTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
