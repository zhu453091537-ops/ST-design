...
import DiscordOutlinedSvg from "@ant-design/icons-svg/es/asn/DiscordOutlined.js";

//#region src/icons/DiscordOutlined.tsx
...
const DiscordOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": DiscordOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { DiscordOutlined as default };