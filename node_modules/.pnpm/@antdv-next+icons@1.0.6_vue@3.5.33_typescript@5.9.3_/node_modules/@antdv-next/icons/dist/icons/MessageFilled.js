...
//#region src/icons/MessageFilled.tsx
...
const MessageFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": MessageFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { MessageFilled as default };