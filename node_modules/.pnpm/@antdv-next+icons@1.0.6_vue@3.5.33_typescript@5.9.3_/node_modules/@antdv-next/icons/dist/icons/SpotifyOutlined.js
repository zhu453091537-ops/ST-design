...
//#region src/icons/SpotifyOutlined.tsx
...
const SpotifyOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": SpotifyOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { SpotifyOutlined as default };