...
//#region src/icons/StarTwoTone.tsx
...
const StarTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": StarTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
