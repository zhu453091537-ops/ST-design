...
import ControlFilledSvg from "@ant-design/icons-svg/es/asn/ControlFilled.js";

//#region src/icons/ControlFilled.tsx
...
const ControlFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": ControlFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { ControlFilled as default };