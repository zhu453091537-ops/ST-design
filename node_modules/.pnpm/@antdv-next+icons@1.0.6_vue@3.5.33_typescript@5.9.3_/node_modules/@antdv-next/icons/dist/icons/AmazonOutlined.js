...
import AmazonOutlinedSvg from "@ant-design/icons-svg/es/asn/AmazonOutlined.js";

//#region src/icons/AmazonOutlined.tsx
...
const AmazonOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": AmazonOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { AmazonOutlined as default };