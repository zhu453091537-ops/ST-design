...
import WechatFilledSvg from "@ant-design/icons-svg/es/asn/WechatFilled.js";

//#region src/icons/WechatFilled.tsx
...
const WechatFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": WechatFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { WechatFilled as default };