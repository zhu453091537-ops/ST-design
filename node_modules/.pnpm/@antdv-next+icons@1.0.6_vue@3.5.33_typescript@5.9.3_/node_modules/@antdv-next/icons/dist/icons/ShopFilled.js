...
//#region src/icons/ShopFilled.tsx
...
const ShopFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": ShopFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
