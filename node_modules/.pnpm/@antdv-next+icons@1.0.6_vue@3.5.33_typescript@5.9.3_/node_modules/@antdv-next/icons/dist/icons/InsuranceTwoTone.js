...
import InsuranceTwoToneSvg from "@ant-design/icons-svg/es/asn/InsuranceTwoTone.js";

//#region src/icons/InsuranceTwoTone.tsx
...
const InsuranceTwoTone = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": InsuranceTwoToneSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { InsuranceTwoTone as default };