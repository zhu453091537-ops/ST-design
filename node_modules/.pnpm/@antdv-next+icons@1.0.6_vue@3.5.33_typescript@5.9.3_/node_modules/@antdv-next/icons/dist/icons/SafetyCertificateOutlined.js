...
//#region src/icons/SafetyCertificateOutlined.tsx
...
const SafetyCertificateOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": SafetyCertificateOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { SafetyCertificateOutlined as default };