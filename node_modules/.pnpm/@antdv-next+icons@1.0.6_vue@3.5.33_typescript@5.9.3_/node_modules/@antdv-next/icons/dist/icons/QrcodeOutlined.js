...
//#region src/icons/QrcodeOutlined.tsx
...
const QrcodeOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": QrcodeOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
