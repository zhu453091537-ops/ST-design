...
//#region src/icons/WeiboSquareOutlined.tsx
...
const WeiboSquareOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": WeiboSquareOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { WeiboSquareOutlined as default };