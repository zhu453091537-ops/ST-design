...
//#region src/icons/CompassFilled.tsx
...
const CompassFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": CompassFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { CompassFilled as default };