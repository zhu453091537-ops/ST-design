...
import ControlOutlinedSvg from "@ant-design/icons-svg/es/asn/ControlOutlined.js";

//#region src/icons/ControlOutlined.tsx
...
const ControlOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": ControlOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { ControlOutlined as default };