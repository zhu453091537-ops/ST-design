...
import BorderTopOutlinedSvg from "@ant-design/icons-svg/es/asn/BorderTopOutlined.js";

//#region src/icons/BorderTopOutlined.tsx
...
const BorderTopOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": BorderTopOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { BorderTopOutlined as default };