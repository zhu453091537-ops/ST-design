...
//#region src/icons/GifOutlined.tsx
...
const GifOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": GifOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
