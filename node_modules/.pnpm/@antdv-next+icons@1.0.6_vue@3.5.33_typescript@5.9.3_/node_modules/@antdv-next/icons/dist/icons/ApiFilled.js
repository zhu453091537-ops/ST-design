...
//#region src/icons/ApiFilled.tsx
...
const ApiFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": ApiFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
