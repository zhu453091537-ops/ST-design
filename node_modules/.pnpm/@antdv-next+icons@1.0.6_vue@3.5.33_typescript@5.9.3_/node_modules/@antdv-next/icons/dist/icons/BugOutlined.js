...
import BugOutlinedSvg from "@ant-design/icons-svg/es/asn/BugOutlined.js";

//#region src/icons/BugOutlined.tsx
...
const BugOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": BugOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
