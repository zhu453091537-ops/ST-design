...
import SettingFilledSvg from "@ant-design/icons-svg/es/asn/SettingFilled.js";

//#region src/icons/SettingFilled.tsx
...
const SettingFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": SettingFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { SettingFilled as default };