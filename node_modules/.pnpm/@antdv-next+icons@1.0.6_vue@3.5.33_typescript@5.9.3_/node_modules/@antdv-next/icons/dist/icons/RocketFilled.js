...
//#region src/icons/RocketFilled.tsx
...
const RocketFilled = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": RocketFilledSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { RocketFilled as default };