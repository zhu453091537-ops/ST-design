...
//#region src/icons/EnvironmentOutlined.tsx
...
const EnvironmentOutlined = /* @__PURE__ */ defineComponent((props) => {
	return () => {
		return createVNode(AntdIcon, mergeProps(props, { "icon": EnvironmentOutlinedSvg }), null);
	};
}, {
	props: {
		twoToneColor: {
...
//#endregion
export { EnvironmentOutlined as default };