import { Sequence, GenIterable, Maybe, LazyIterable, ChainFunction, ThenArg } from './types.js';
export declare class ImplSequence<T> implements Sequence<T> {
    ...
    private inject;
    private chain;
    [Symbol.iterator](): Iterator<T, any, any> | IterableIterator<T>;
    ...
    toArray(): T[];
    toIterable(): Generator<T, void, any>;
}
