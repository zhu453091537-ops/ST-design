...
export declare function trimPackageConfig(pcfg: PackageConfig): PackageConfig;
/**
...
export declare function parseUrlTarget(resolver: Resolver, targetStr: string, parentUrl?: URL): Promise<Install | undefined>;
