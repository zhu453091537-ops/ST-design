...
hooks.add('tableEditModule', {
  setupTable($xeTable) {
    ...
    const handleInsertRowAt = (records, targetRowOrRowid, isInsertNextRow) => {
      ...
      if (_xeUtils.default.isString(targetRowOrRowid) || _xeUtils.default.isNumber(targetRowOrRowid)) {
      ...
      if (_xeUtils.default.eqNull(targetRow)) {
        ...
        if (treeConfig && transform) {
          ...
          (0, _log.errLog)(getI18n('vxe.error.noGroup', ['insert']));
    ...
    const handleInsertChildRowAt = (records, parentRowOrParentId, targetRow, isInsertNextRow) => {
      ...
      if (treeConfig && transform) {
        ...
        if (_xeUtils.default.isString(parentRowOrParentId) || _xeUtils.default.isNumber(parentRowOrParentId)) {
