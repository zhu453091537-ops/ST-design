        ...
        if ((0, _utils.isEnableConf)(menuConfig)) {
          ...
          for (let index = 0; index < layoutList.length; index++) {
            ...
            if (columnTargetNode.flag) {
              ...
              return;
            } else if ((0, _dom.getEventTargetNode)(evnt, el, `vxe-table--${layout}-wrapper`, target => target.getAttribute('xid') === xID).flag || layout === 'body' && (0, _dom.getEventTargetNode)(evnt, el, 'vxe-table--empty-place-wrapper', target => target.getAttribute('xid') === xID).flag) {
