...
declare type TippyElement = Element | any;
...
}, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, Record<string, any>, string, import("vue").VNodeProps & import("vue").AllowedComponentProps & import("@vue/runtime-core").ComponentCustomProps, Readonly<import("vue").ExtractPropTypes<ComponentObjectPropsOptions<Record<string, unknown>>>>, {}>;
...
export declare function useTippy(el: TippyElement | (() => TippyElement) | Ref<TippyElement> | Ref<TippyElement | undefined>, opts?: TippyOptions, settings?: {
    mount: boolean;
    appName: string;
}): {
