import { InternalMode, Locale, SharedPickerProps } from '../interface';
...
export declare function getRowFormat(picker: InternalMode, locale: Locale, format?: SharedPickerProps['format'] | null): {
    format: string;
    type?: "mask";
