import { InternalMode, Locale, SharedPickerProps, SharedTimeProps } from '../interface';
...
export declare function fillShowTimeConfig<DateType extends object>(picker: InternalMode, showTimeFormat: string | undefined, propFormat: string, timeConfig: SharedTimeProps<DateType>, locale: Locale): SharedTimeProps<DateType> | null;
