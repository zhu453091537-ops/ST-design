import { CrossOrigin, ERROR_LEVEL_MAPPED_TYPE, ErrorCorrectionLevel, Excavation, ImageSettings, Modules } from './interface';
 ...
 * @returns
 */
export declare function excavateModules(modules: Modules, excavation: Excavation): boolean[][];
/**
 * Get image settings
