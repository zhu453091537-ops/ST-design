...
//#region src/alert/style/index.ts
function genAlertTypeStyle(bgColor, borderColor, iconColor, token, alertCls) {
	return {
		background: bgColor,
...
var style_default = genStyleHooks("Alert", (token) => [
	genBaseStyle(token),
	genTypeStyle(token),
...
//#endregion
export { style_default as default, genActionStyle, genBaseStyle, genTypeStyle, prepareComponentToken };