import ko_KR_default$1 from "../time-picker/locale/ko_KR.js";
import ko_KR_default$2 from "../date-picker/locale/ko_KR.js";
import ko_KR_default$3 from "../calendar/locale/ko_KR.js";
import Pagination from "@v-c/pagination/locale/ko_KR";

//#region src/locale/ko_KR.ts
const typeTemplate = "${label} 유효하지 않은 ${type}";
const localeValues = {
	locale: "ko",
	Pagination,
	DatePicker: ko_KR_default$2,
	TimePicker: ko_KR_default$1,
	Calendar: ko_KR_default$3,
	global: {
		placeholder: "선택하세요",
		close: "닫기"
	},
	...
	Form: {
		...
		defaultValidateMessages: {
			...
			pattern: { mismatch: "${label} ${pattern} 패턴과 일치하지 않습니다" }
		}
	},
	QRCode: {
		expired: "만료된 QR 코드",
...
var ko_KR_default = localeValues;
