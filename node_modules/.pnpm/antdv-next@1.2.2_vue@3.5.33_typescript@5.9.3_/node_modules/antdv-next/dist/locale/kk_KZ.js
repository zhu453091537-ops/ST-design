...
import kk_KZ_default$2 from "../date-picker/locale/kk_KZ.js";
import kk_KZ_default$3 from "../calendar/locale/kk_KZ.js";
import Pagination from "@v-c/pagination/locale/kk_KZ";

//#region src/locale/kk_KZ.ts
const typeTemplate = "${label} ${type} типі емес";
const localeValues = {
	locale: "kk",
	Pagination,
	DatePicker: kk_KZ_default$2,
	TimePicker: kk_KZ_default$1,
	Calendar: kk_KZ_default$3,
	global: {
	...
	Form: { defaultValidateMessages: {
		...
		pattern: { mismatch: "${label} ${pattern} мен сәйкес келмейді" }
	} }
};
var kk_KZ_default = localeValues;
