...
import he_IL_default$2 from "../date-picker/locale/he_IL.js";
import he_IL_default$3 from "../calendar/locale/he_IL.js";
import Pagination from "@v-c/pagination/locale/he_IL";

//#region src/locale/he_IL.ts
const typeTemplate = "${label} הוא לא ${type} תקין";
const localeValues = {
	locale: "he",
	Pagination,
	DatePicker: he_IL_default$2,
	TimePicker: he_IL_default$1,
	Calendar: he_IL_default$3,
	global: {
		placeholder: "אנא בחר",
		close: "סגור"
	},
	...
	Form: { defaultValidateMessages: {
		...
		pattern: { mismatch: "${label} לא תואם לתבנית ${pattern}" }
	} }
};
var he_IL_default = localeValues;
