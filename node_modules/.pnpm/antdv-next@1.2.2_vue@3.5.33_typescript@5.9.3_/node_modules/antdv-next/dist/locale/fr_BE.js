...
import fr_BE_default$2 from "../date-picker/locale/fr_BE.js";
import fr_BE_default$3 from "../calendar/locale/fr_BE.js";
import Pagination from "@v-c/pagination/locale/fr_BE";

//#region src/locale/fr_BE.ts
const typeTemplate = "La valeur du champ ${label} n'est pas valide pour le type ${type}";
const localeValues = {
	locale: "fr",
	Pagination,
	DatePicker: fr_BE_default$2,
	TimePicker: fr_BE_default$1,
	Calendar: fr_BE_default$3,
	global: { close: "Fermer" },
	Table: {
		filterTitle: "Filtrer",
		filterConfirm: "OK",
...
var fr_BE_default = localeValues;
