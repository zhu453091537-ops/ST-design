...
import kn_IN_default$2 from "../date-picker/locale/kn_IN.js";
import kn_IN_default$3 from "../calendar/locale/kn_IN.js";
import Pagination from "@v-c/pagination/locale/kn_IN";

//#region src/locale/kn_IN.ts
const typeTemplate = "${label} ಮಾನ್ಯವಾದ ${type} ಅಲ್ಲ";
const localeValues = {
	locale: "kn",
	Pagination,
	DatePicker: kn_IN_default$2,
	TimePicker: kn_IN_default$1,
	Calendar: kn_IN_default$3,
	global: {
	...
	Form: {
		...
		defaultValidateMessages: {
			...
			pattern: { mismatch: "${label} ಮಾದರಿಯು ${pattern} ಗೆ ಹೊಂದಿಕೆಯಾಗುವುದಿಲ್ಲ" }
		}
	},
	QRCode: {
...
var kn_IN_default = localeValues;
