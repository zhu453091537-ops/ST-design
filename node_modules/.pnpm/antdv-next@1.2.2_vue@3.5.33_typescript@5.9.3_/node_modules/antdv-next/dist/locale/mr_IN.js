...
import mr_IN_default$2 from "../date-picker/locale/mr_IN.js";
import mr_IN_default$3 from "../calendar/locale/mr_IN.js";
import Pagination from "@v-c/pagination/locale/mr_IN";

//#region src/locale/mr_IN.ts
const typeTemplate = "${label} हा वैध ${type} नाही";
const localeValues = {
	locale: "mr",
	DatePicker: mr_IN_default$2,
	TimePicker: mr_IN_default$1,
	Calendar: mr_IN_default$3,
	Pagination,
	global: {
	...
	Empty: { description: "कोणतीही माहिती नाही" },
	Icon: { icon: "आयकॉन" },
	Text: {
		edit: "संपादन करा",
		copy: "कॉपी करा",
	...
	Form: {
		...
		defaultValidateMessages: {
			...
			pattern: { mismatch: "${label} हे ${pattern} पॅटर्नशी जुळत नाही" }
		}
	}
};
var mr_IN_default = localeValues;
