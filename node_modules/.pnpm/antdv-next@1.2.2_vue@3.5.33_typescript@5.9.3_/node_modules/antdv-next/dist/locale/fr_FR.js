...
import fr_FR_default$2 from "../date-picker/locale/fr_FR.js";
import fr_FR_default$3 from "../calendar/locale/fr_FR.js";
import Pagination from "@v-c/pagination/locale/fr_FR";

//#region src/locale/fr_FR.ts
const typeTemplate = "La valeur du champ ${label} n'est pas valide pour le type ${type}";
const localeValues = {
	locale: "fr",
	Pagination,
	DatePicker: fr_FR_default$2,
	TimePicker: fr_FR_default$1,
	Calendar: fr_FR_default$3,
	global: { close: "Fermer" },
	Table: {
		filterTitle: "Filtrer",
		filterConfirm: "OK",
...
var fr_FR_default = localeValues;
