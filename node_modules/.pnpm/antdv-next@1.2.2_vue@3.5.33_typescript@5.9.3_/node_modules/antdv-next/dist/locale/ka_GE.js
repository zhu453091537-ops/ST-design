...
import ka_GE_default$2 from "../date-picker/locale/ka_GE.js";
import ka_GE_default$3 from "../calendar/locale/ka_GE.js";
import Pagination from "@v-c/pagination/locale/ka_GE";

//#region src/locale/ka_GE.ts
const typeTemplate = "${label} არ არის სწორი ${type}";
const localeValues = {
	locale: "ka",
	Pagination,
	DatePicker: ka_GE_default$2,
	TimePicker: ka_GE_default$1,
	Calendar: ka_GE_default$3,
	global: {
	...
	Form: {
		...
		defaultValidateMessages: {
			...
			pattern: { mismatch: "${label} არ ერგება შაბლონს ${pattern}" }
		}
	}
};
var ka_GE_default = localeValues;
