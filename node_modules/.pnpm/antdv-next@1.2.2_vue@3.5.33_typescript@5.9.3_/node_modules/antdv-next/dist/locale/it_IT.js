...
import it_IT_default$2 from "../date-picker/locale/it_IT.js";
import it_IT_default$3 from "../calendar/locale/it_IT.js";
import Pagination from "@v-c/pagination/locale/it_IT";

//#region src/locale/it_IT.ts
const typeTemplate = " ${label} non è un ${type} valido";
const localeValues = {
	locale: "it",
	Pagination,
	DatePicker: it_IT_default$2,
	TimePicker: it_IT_default$1,
	Calendar: it_IT_default$3,
	global: {
	...
	Form: {
		...
		defaultValidateMessages: {
			...
			pattern: { mismatch: "${label} non corrisponde al modello ${pattern}" }
		}
	},
	QRCode: {
...
var it_IT_default = localeValues;
