...
import fa_IR_default$2 from "../date-picker/locale/fa_IR.js";
import fa_IR_default$3 from "../calendar/locale/fa_IR.js";
import Pagination from "@v-c/pagination/locale/fa_IR";

//#region src/locale/fa_IR.ts
const typeTemplate = "${label} از نوع ${type} معتبر نیست";
const localeValues = {
	locale: "fa",
	Pagination,
	DatePicker: fa_IR_default$2,
	TimePicker: fa_IR_default$1,
	Calendar: fa_IR_default$3,
	global: {
	...
	Form: {
		...
		defaultValidateMessages: {
			...
			pattern: { mismatch: "الگوی ${label} با ${pattern} برابری نمی‌کند" }
		}
	},
	QRCode: {
...
var fa_IR_default = localeValues;
