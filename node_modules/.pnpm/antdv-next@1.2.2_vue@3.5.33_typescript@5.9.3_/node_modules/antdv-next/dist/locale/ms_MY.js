...
import ms_MY_default$2 from "../date-picker/locale/ms_MY.js";
import ms_MY_default$3 from "../calendar/locale/ms_MY.js";
import Pagination from "@v-c/pagination/locale/ms_MY";

//#region src/locale/ms_MY.ts
const typeTemplate = "${label} bukan ${type} jenis yang sah";
const localeValues = {
	locale: "ms-my",
	Pagination,
	DatePicker: ms_MY_default$2,
	TimePicker: ms_MY_default$1,
	Calendar: ms_MY_default$3,
	global: {
	...
	Form: {
		...
		defaultValidateMessages: {
			...
			pattern: { mismatch: "${label} tidak sesuai ${pattern}" }
		}
	},
	QRCode: {
...
var ms_MY_default = localeValues;
