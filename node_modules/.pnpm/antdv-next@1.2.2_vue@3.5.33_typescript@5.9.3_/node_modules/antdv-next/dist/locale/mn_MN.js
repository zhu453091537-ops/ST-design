...
import mn_MN_default$2 from "../date-picker/locale/mn_MN.js";
import mn_MN_default$3 from "../calendar/locale/mn_MN.js";
import Pagination from "@v-c/pagination/locale/mn_MN";

//#region src/locale/mn_MN.ts
const typeTemplate = "${label} нь хүчинтэй ${type} биш";
const localeValues = {
	locale: "mn-mn",
	Pagination,
	DatePicker: mn_MN_default$2,
	TimePicker: mn_MN_default$1,
	Calendar: mn_MN_default$3,
	global: {
	...
	Form: {
		...
		defaultValidateMessages: {
			...
			pattern: { mismatch: "${label} нь ${pattern} загвартай тохирохгүй байна" }
		}
	}
};
var mn_MN_default = localeValues;
