...
import et_EE_default$2 from "../date-picker/locale/et_EE.js";
import et_EE_default$3 from "../calendar/locale/et_EE.js";
import Pagination from "@v-c/pagination/locale/et_EE";

//#region src/locale/et_EE.ts
const typeTemplate = "${label} ei ole kehtiv ${type}";
const localeValues = {
	locale: "et",
	Pagination,
	DatePicker: et_EE_default$2,
	TimePicker: et_EE_default$1,
	Calendar: et_EE_default$3,
	global: {
	...
	Form: {
		...
		defaultValidateMessages: {
			...
			pattern: { mismatch: "${label} ei vasta mustrile ${pattern}" }
		}
	}
};
var et_EE_default = localeValues;
