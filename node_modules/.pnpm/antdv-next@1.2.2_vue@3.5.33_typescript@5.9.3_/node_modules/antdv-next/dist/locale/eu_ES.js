...
import eu_ES_default$2 from "../date-picker/locale/eu_ES.js";
import eu_ES_default$3 from "../calendar/locale/eu_ES.js";
import Pagination from "@v-c/pagination/locale/eu_ES";

//#region src/locale/eu_ES.ts
const typeTemplate = "${label} ez da ${type} balioduna";
const localeValues = {
	locale: "eu",
	Pagination,
	DatePicker: eu_ES_default$2,
	TimePicker: eu_ES_default$1,
	Calendar: eu_ES_default$3,
	global: {
	...
	Empty: { description: "Ez dago daturik" },
	Icon: { icon: "ikono" },
	Text: {
		edit: "Editatu",
		copy: "Kopiatu",
	...
	Form: {
		...
		defaultValidateMessages: {
			...
			pattern: { mismatch: "${label} ez dator bat ${pattern} patroiarekin" }
		}
	},
	QRCode: {
...
var eu_ES_default = localeValues;
