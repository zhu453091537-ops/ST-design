...
import my_MM_default$2 from "../date-picker/locale/my_MM.js";
import my_MM_default$3 from "../calendar/locale/my_MM.js";
import Pagination from "@v-c/pagination/locale/my_MM";

//#region src/locale/my_MM.ts
const typeTemplate = "${label} သည် တရားဝင် ${type} မဟုတ်ပါ";
const localeValues = {
	locale: "my",
	Pagination,
	DatePicker: my_MM_default$2,
	TimePicker: my_MM_default$1,
	Calendar: my_MM_default$3,
	global: {
	...
	Form: {
		...
		defaultValidateMessages: {
			...
			pattern: { mismatch: "${label} သည် ပုံစံ ${pattern} နှင့် မကိုက်ညီပါ" }
		}
	},
	QRCode: {
...
var my_MM_default = localeValues;
