...
import ml_IN_default$2 from "../date-picker/locale/ml_IN.js";
import ml_IN_default$3 from "../calendar/locale/ml_IN.js";
import Pagination from "@v-c/pagination/locale/ml_IN";

//#region src/locale/ml_IN.ts
const typeTemplate = "${label} അസാധുവായ ${type} ആണ്";
const localeValues = {
	locale: "ml",
	Pagination,
	DatePicker: ml_IN_default$2,
	TimePicker: ml_IN_default$1,
	Calendar: ml_IN_default$3,
	global: {
	...
	Form: {
		...
		defaultValidateMessages: {
			...
			pattern: { mismatch: "${label} ${pattern} മാതൃകയുമായി യോജിക്കുന്നില്ല" }
		}
	}
};
var ml_IN_default = localeValues;
