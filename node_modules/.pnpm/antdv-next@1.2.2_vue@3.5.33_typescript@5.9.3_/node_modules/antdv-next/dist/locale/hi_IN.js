...
import hi_IN_default$2 from "../date-picker/locale/hi_IN.js";
import hi_IN_default$3 from "../calendar/locale/hi_IN.js";
import Pagination from "@v-c/pagination/locale/hi_IN";

//#region src/locale/hi_IN.ts
const typeTemplate = "${label} मान्य ${type} नहीं है";
const localeValues = {
	locale: "hi",
	Pagination,
	DatePicker: hi_IN_default$2,
	TimePicker: hi_IN_default$1,
	Calendar: hi_IN_default$3,
	global: {
	...
	Form: {
		...
		defaultValidateMessages: {
			...
			pattern: { mismatch: "${label} ${pattern} पैटर्न से मेल नहीं खाता" }
		}
	}
};
var hi_IN_default = localeValues;
