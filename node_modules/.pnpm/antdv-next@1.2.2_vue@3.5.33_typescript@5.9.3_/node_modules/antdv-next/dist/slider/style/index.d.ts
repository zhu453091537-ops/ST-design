...
import * as vue880 from "vue";

//#region src/slider/style/index.d.ts
...
declare const prepareComponentToken: GetDefaultToken<'Slider'>;
declare const _default: (prefixCls: vue880.Ref<string>, rootCls?: vue880.Ref<string | undefined>) => readonly [vue880.Ref<string, string>, vue880.ComputedRef<string | undefined>];
//#endregion
