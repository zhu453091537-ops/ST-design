...
//#region src/select/style/token.d.ts
interface MultipleSelectorToken {
  /**
   * @desc 多选标签背景色
...
interface ComponentToken extends MultipleSelectorToken {
  /**
   * @desc 下拉菜单 z-index
...
interface SelectToken extends FullToken<'Select'>, SelectorToken {
  rootPrefixCls: string;
  /** @private Used for internal calculation */
  INTERNAL_FIXED_ITEM_MARGIN: number;
}
declare const prepareComponentToken: GetDefaultToken<'Select'>;
//#endregion
export { ComponentToken, MultipleSelectorToken, SelectToken, SelectorToken, prepareComponentToken };