...
import { MultipleSelectorToken, SelectorToken } from "../../select/style/token.js";
import { ArrowToken } from "../../style/roundedArrow.js";
import { FullToken, GetDefaultToken, GlobalToken } from "../../theme/interface/cssinjs-utils.js";
import { TokenWithCommonCls } from "../../theme/internal.js";

//#region src/date-picker/style/token.d.ts
...
interface PickerToken extends FullToken<'DatePicker'>, PickerPanelToken, SharedInputToken, SelectorToken {
...
declare function initPickerPanelToken(token: TokenWithCommonCls<GlobalToken>): PickerPanelToken;
declare function initPanelComponentToken(token: GlobalToken): PanelComponentToken;
declare const prepareComponentToken: GetDefaultToken<'DatePicker'>;
//#endregion
export { ComponentToken, PanelComponentToken, PickerPanelToken, PickerToken, SharedPickerToken, initPanelComponentToken, initPickerPanelToken, prepareComponentToken };