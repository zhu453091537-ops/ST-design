...
interface ButtonToken extends FullToken<'Button'>, ShadowColorMap, PresetColorHoverActiveMap, GroupToken {
  /**
   * @desc 按钮横向内边距
   * @descEN Horizontal padding of button
   */
...
declare function prepareToken(token: Parameters<GenStyleFn<'Button'>>[0]): ButtonToken;
declare const prepareComponentToken: GetDefaultToken<'Button'>;
//#endregion
export { ButtonToken, ComponentToken, prepareComponentToken, prepareToken };