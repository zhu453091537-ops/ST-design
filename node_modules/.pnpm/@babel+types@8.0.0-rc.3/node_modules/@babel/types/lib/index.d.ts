...
interface ParentMaps {
    ...
    Placeholder: Node;
    PrivateName: BinaryExpression | ClassAccessorProperty | ClassPrivateMethod | ClassPrivateProperty | MemberExpression | ObjectProperty | OptionalMemberExpression;
...
declare function newExpression(callee: Expression | Super | Import | V8IntrinsicIdentifier, _arguments: (Expression | SpreadElement | ArgumentPlaceholder)[]): NewExpression;
...
declare function classProperty(key: Identifier | StringLiteral | NumericLiteral | BigIntLiteral | Expression, value?: Expression | null, typeAnnotation?: TypeAnnotation | TSTypeAnnotation | null, decorators?: Decorator[] | null, computed?: boolean, _static?: boolean): ClassProperty;
...
declare function tsDeclareMethod(key: Identifier | StringLiteral | NumericLiteral | BigIntLiteral, typeParameters: TSTypeParameterDeclaration | null | undefined, params: (FunctionParameter | TSParameterProperty)[], returnType?: TSTypeAnnotation | null): Extract<TSDeclareMethod, {
    computed: false;
}>;
declare function tsDeclareMethod(key: Identifier | StringLiteral | NumericLiteral | BigIntLiteral | Expression, typeParameters: TSTypeParameterDeclaration | null | undefined, params: (FunctionParameter | TSParameterProperty)[], returnType?: TSTypeAnnotation | null): TSDeclareMethod;
...
type ValidatorImpl = (node: Node | null | undefined, key: string | {
    toString(): string;
}, val: any) => void;
type ValidatorType = {
    type: PrimitiveTypes;
