...
import * as __rspack_external_node_cleanup_b4b618cf from "node-cleanup";
import * as __rspack_external_node_worker_threads_773e82b0 from "node:worker_threads";
import * as __rspack_external_update_notifier_9549a061 from "update-notifier";
import * as __rspack_external_zx from "zx";
var __webpack_modules__ = {
    "./src/cli.ts" (module, __webpack_exports__, __webpack_require__) {
        __webpack_require__.a(module, async function(__rspack_load_async_deps, __rspack_async_done) {
            try {
                __webpack_require__.r(__webpack_exports__);
                var commander__rspack_import_0 = __webpack_require__("commander");
                var node_cleanup__rspack_import_1 = __webpack_require__("node-cleanup");
                var update_notifier__rspack_import_2 = __webpack_require__("update-notifier");
                var zx__rspack_import_3 = __webpack_require__("zx");
                var _package_json__rspack_import_4 = __webpack_require__("./package.json");
                var _index__rspack_import_5 = __webpack_require__("./src/index.ts?5867");
                var __rspack_async_deps = __rspack_load_async_deps([
                    _index__rspack_import_5
                ]);
                _index__rspack_import_5 = (__rspack_async_deps.then ? (await __rspack_async_deps)() : __rspack_async_deps)[0];
                const startAt = Date.now();
                (0, node_cleanup__rspack_import_1["default"])((exitCode)=>console.log(exitCode ? `${zx__rspack_import_3.chalk.red.bold('error')} Command failed with exit code ${exitCode}.` : `✨ Done in ${((Date.now() - startAt) / 1000).toFixed(2)}s.`));
                commander__rspack_import_0.program.version(_package_json__rspack_import_4.rE).description(_package_json__rspack_import_4.h_).showHelpAfterError('(add --help for additional information)').hook('preAction', ()=>(0, update_notifier__rspack_import_2["default"])({
                        pkg: {
                            name: _package_json__rspack_import_4.UU,
                            version: _package_json__rspack_import_4.rE
                        }
                    }).notify({
                        isGlobal: true
                    }));
                commander__rspack_import_0.program.argument('[path]', 'command execute path. (default: process.cwd())').option('--filter <pattern>', 'glob pattern to filter output circles.').option('--exclude-types', 'exclude pure type-references when calculating circles.').option('--absolute', 'print absolute path instead. usually use with editor which can quickly jump to the file.', false).option('-o, --output <filename>', 'output the analysis into specified json file.').option('-i, --ignore <patterns...>', 'glob patterns to exclude matches.', [
                    ...
                    const cycles = await (0, _index__rspack_import_5.x6)({
                        ...rest,
                        cwd
                    });
                    if (!cycles.length) return;
                    if (output) {
                        zx__rspack_import_3.fs.writeFileSync(output || 'circles.json', JSON.stringify(cycles, null, 2));
                        _index__rspack_import_5.vF.info(`Output has been redirected to ${zx__rspack_import_3.chalk.cyan.underline(output)}`);
                    } else (0, _index__rspack_import_5.jn)(cycles);
                    if (isThrow) {
                        _index__rspack_import_5.vF.error('Command failed with exit code 1');
                        process.exit(1);
                    }
                });
                commander__rspack_import_0.program.parse();
                __rspack_async_done();
            } catch (e) {
    ...
    "./src/index.ts?5867" (module, __webpack_exports__, __webpack_require__) {
        __webpack_require__.a(module, async function(__rspack_load_async_deps, __rspack_async_done) {
            try {
                __webpack_require__.d(__webpack_exports__, {
                    jn: ()=>_utils__rspack_import_2.jn,
                    vF: ()=>_logger__rspack_import_1.v,
                    x6: ()=>_circle__rspack_import_0.x
                });
    ...
    "node-cleanup" (module) {
        module.exports = __rspack_external_node_cleanup_b4b618cf;
    },
    "node:worker_threads" (module) {
        module.exports = __rspack_external_node_worker_threads_773e82b0;
    },
    "update-notifier" (module) {
        module.exports = __rspack_external_update_notifier_9549a061;
    },
    zx (module) {
    ...
    "./package.json" (module) {
        module.exports = JSON.parse('{"UU":"circular-dependency-scanner","rE":"3.0.1","h_":"Out-of-box and zero configuration circular dependencies detector, with both JavaScript API and Command Line Tool."}');
    },
